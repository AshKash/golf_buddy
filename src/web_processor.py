...
class WebProcessor:
    ...
    def initialize(self):
        ...
        try:
            ...
            logger.error(f"Error initializing WebProcessor: {str(e)}")
            self.close()
            raise
    ...
    def get_visible_rendered_html(self, url: str) -> str:
        ...
        try:
            ...
            # Try to reinitialize the browser on error
            try:
                self.initialize()
            except Exception as init_error:
                logger.error(f"Failed to reinitialize browser: {str(init_error)}")
            return ""
        finally:
            # Clean up page
            if page:
